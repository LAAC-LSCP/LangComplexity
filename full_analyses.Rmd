...
## Mean CR and Standard Deviation (box-plots included)
...
#summary(mydata_sub)
"Moderately Small Mad_C"; cor.test(mydata_sub_S$age,mydata_sub_S$CR) #0.87546 
"Average Mad_C"; cor.test(mydata_sub_A$age,mydata_sub_A$CR) #0.587497 
"Large Mad_C"; cor.test(mydata_sub_L$age,mydata_sub_L$CR) #0.6306421 

ggqqplot(mydata_sub_A$age, ylab = "Age")+
  labs(title = "Pearson's correlations for Average Consonants by Age") 
ggqqplot(mydata_sub_A$CR, ylab = "CR")+
  labs(title = "Pearson's correlations for Average Consonants by CR") 
...
summary(mydata_sub)
"Average Mad_VQ"; cor.test(mydata_sub_Av$age,mydata_sub_Av$CR,)  #0.4773039
"Large Mad_VQ"; cor.test(mydata_sub_Lr$age,mydata_sub_Lr$CR)  #0.7266499
...
** I get - 16117 parsing failures when try to run raw_cychosz_data<- read_csv("Data/meta_answers_global_crossling_9-20.csv")
